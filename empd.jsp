...
<%! String
eid,ename,gender,empaddress,desgname,aid,expskills,deptid,emailid,date,r1,r2,dates,phone;
%>
<%
try{
eid=(String)session.getAttribute("userid");
//out.println(eid);
...
<form action="empupdate.jsp" name="myform">
<center>
<table border="1">
<tr>
...
<font size="4" face="times new roman" color="black"><input type="radio" name="r2" value="female" <%=r2%> disabled/>FEMALE</td>
</tr>
<tr>
<td><font size="4" face="times new roman" color="black">EMPLOYEE ADDRESS</td>
<td><textarea rows="2" name="eaddr" cols="20" disabled/><%=empaddress%></textarea>
</tr>
<tr>
<td><font size="4" face="times new roman" color="black">DEPARTMENT ID</td>
<td><input type="text" name="deptno" value="<%=deptid%>" disabled/></td>
</tr>
<tr>
<td><font size="4" face="times new roman" color="black">DESIGNATION NAME</td>
<td><select name="designame" disabled><option>GM</option><option>DGM</option><option>SM</option><option>TO</option> </select></td>
</tr>
<tr>
<td><font size="4" face="times new roman" color="black">AUTHORITY ID</td>
<td><input type="text" name="aid" value="<%=aid%>"disabled/></td>
</td>
</tr>
</tr>
<tr>
<td><font size="4" face="times new roman" color="black">PHONE</td>
<td><input type="text" name="ephne" value="<%=phone%>" disabled/></td>
</tr>
<tr>
<td><font size="4" face="times new roman" color="black">EMAIL ID</td>
<td><input type="text" name="emailid" value="<%=emailid%>" disabled/></td>
<tr>
<td><font size="4" face="times new roman" color="black">EXPERT SKILLS</td>
<td><input type="text" name="expskills" value="<%=expskills%>" disabled/></td>
</tr>
<tr>
<td><font size="4" face="times new roman" color="black">DATE OF BIRTH</td>
<td><input type="text" name="DOB" value="<%=date%>" disabled/></td>
</tr>
<td><font size="4" face="times new roman" color="black">DATE OF JOIN</td>
<td><input type="text" name="DOJ" value="<%=dates%>" disabled/></td>
</tr>
<tr>
</tr>
<tr>
...
<td><input type="button" value="CANCEL" onClick="window.location.replace('home1.jsp')"/></td>
</tr>
</table>
</form>
</center>
