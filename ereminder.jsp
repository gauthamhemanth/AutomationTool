...
<tr>
<td><font size="4" face="times new roman" color="black">REMINDER ID</td>
<td><input type="text" name="rid"/></td>
</tr>
<tr>
<td><font size="4" face="times new roman" color="black">REMINDER DATE</td>
<td><select name="date">
<%
for(int i=1;i<=31;i++)
{
...
<tr>
<td><font size="4" face="times new roman" color="black">TARGET DATE</td>
<td><select name="date">
<%
for(int i=1;i<=31;i++)
{
